    ...
    <x-app-layout>
        ...
        <div class="p-4 sm:ml-64 mt-16">
            <div class="flex w-full items-center rounded-full">
                ...
                <span class="text-black text-lg font-semibold leading-8 px-8 py-3 uppercase">{{trans('message.add-product')}}</span>
                <div class="flex-1 border-b border-gray-300"></div>
            </div>
                                    ...
                                    <label for="sub_image"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-6 pb-6">
                                            ...
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                                    class="font-semibold">{{trans('message.click-to-upload')}}</span> {{trans('message.drag-and-drop')}}</p>
                                        </div>
                            ...
                            <div class="mb-3">
                                <div class="size-container">
                                    <div class="flex items-center gap-5 mb-3" id="size-container">
                                        <div class="mb-3 basis-1/2">
                                            <label for="name-size"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{trans('message.name-size')}}</label>
                                        ...
                                        <div class="mb-3 basis-1/2">
                                            <label for=""
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{trans('message.quantity')}}</label>
